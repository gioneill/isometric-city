...
struct RootGameHostView: View {
    ...
    private var currentConfiguration: GameLoadConfiguration? {
        ...
        return GameLoadConfiguration(gameURL: url, gestureMode: "native")
    }
    ...
    private var nativeGestureLayerEnabled: Bool {
        model.hasReceivedHostState
    }
